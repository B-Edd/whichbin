...
function displayAutoCompleteList() {
  ...
  // Create an array of items from bins
  var itemArray = Object.keys(bins);

  // Sort the item array alphabetically
  itemArray.sort();

  // Add options for each item in sorted itemArray
  for (var i = 0; i < itemArray.length; i++) {
    var item = itemArray[i];
    var option = document.createElement("option");

    // Highlight matching letter in option text
...
// Display the autocomplete list on page load
